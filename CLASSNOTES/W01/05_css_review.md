...
1. In VS Code, add a new subfolder named "week01" within your wdd131 local repository folder.
1. Add a file named "basic-layout.html" to the week01 folder.
1. Add a new subfolder within the week01 folder named "styles".
1. Create a supporting, external CSS file named "layout.css" and place it in the styles folder.

HTML
1. In the basic-layout.html file, use semantic HTML to support the given layout.
1. Consider using an Emmet shortcut in VS Code by typing html5 or just an ! and then pressing the Tab key in a blank HTML document. This action will generate a core HTML structure.

1. Ensure that your navigation element is placed within the header element.
1. Include the placeholder content (e.g., "Header Content").
1. Link the external CSS file.
1. Always use appropriate title content. In this assignment, include your name and WDD 131.

CSS
1. Use CSS Grid on the body of the document to support the given layout.
1. Typically, you should avoid using Grid on the <body> element because it makes it harder to override styles for specific sections and complicates maintainability with more complex layouts. If you need to use Grid for the body content, consider using a separate container element and applying Grid to that container. However, this activity's website has a straightforward structure with clearly defined sections, so using Grid on the <body> is an efficient choice.

1. Use CSS Flex on the navigation menu.
1. The color scheme and font family are your choice.

Test Page
1. Check your work by loading your page into your browser using Live/Five Server through VS Code.
1. Validate your HTML and CSS.
1. Use DevTools Lighthouse for a deeper dive into your page's performance, accessibility, and adherence to best practices.
...
1. Wait a few minutes for the server to update, then check how your page renders in a browser.

What is the GitHub Pages enabled URL to your page?
<https://yourgithubusername.github.io/wdd131/week01/basic-layout.html>
1. Does it look like the example screenshot above? If not, make corrections and push your changes.
1. Discuss issues with your peers and the instructor in the Microsoft Teams Week 01 Forum channel.
1. Continue to make corrections and adjustments as needed and remember to commit and push your changes.
