...
1. scores[0] = 99; // This assignment expression changed the first score in the array from 100 to 99.
1. Arrays can be iterated over using a classic for loop:
...
What is the index of the last item in the array? (Svetlana)
